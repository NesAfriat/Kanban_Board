...
public class WorkerController {
    ...
    private final WorkersList workersList;
    ...
    public Worker getLoggedIn() throws InnerLogicException {
        if (loggedIn == null)
            throw new InnerLogicException("tried to get  the logged in worker but no worker was logged in");
        return loggedIn;
    }
    ...
    public Worker addWorker(String name, String id, String bankAccount, double salary, String educationFund,
        ...
        if (loggedIn == null)
            throw new InnerLogicException("cant add new worker to the system because no worker is logged in");
    ...
    public Worker getWorker(String id) throws InnerLogicException {
        if (loggedIn != null && !loggedIn.getIsAdmin())
            throw new InnerLogicException("non admin worker tried to get details of another worker");
    ...
    public Worker addOccupation(String id, String job) throws InnerLogicException {
        if (loggedIn == null || !loggedIn.getIsAdmin())
            throw new InnerLogicException("non admin worker tried to add occupation to a worker");
        VerifyNotAdministrator(id);
