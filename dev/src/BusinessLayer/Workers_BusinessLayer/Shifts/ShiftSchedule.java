...
public class ShiftSchedule {
    private final Map<String, WorkDay> workDays;
    private final DefaultWorkDayHolder defaultWorkDayHolder;
    private final List<Pair> requestList;
    ...
    private class DefaultWorkDayHolder {
        ...
        private final WorkerDataController workerDataController = new WorkerDataController();
