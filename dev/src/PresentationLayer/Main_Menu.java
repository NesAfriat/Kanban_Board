...
public class Main_Menu {
    ...
    facade Facade;
    //------------------------------------------------------
    private final SupplierFunctionality supplierFunctionality;
    private final OrderFunctionality orderFunctionality;
    private final Stock_Main_Menu InventPresentation;
    private final Workers_Main_Menu workers_menu;
    private final Transport_Menu transport_menu;
