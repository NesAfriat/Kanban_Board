...
//        "print supplier agreement","set Product Price","set Supplier Payment","Remove Discount by Quantity of Product","Remove Contact","Set Delivery Mode","go back"};
    ...
    public void addNewSupplier(){
        ...
        System.out.println("now we will add first Product");
        ...
        response=facade.addNewSupplier(id,name,bankAccount,paymentMethods,deliveryMode,days,daysF,contactName,email,phoneNumber,price,catalogId,manfucator,ProductName);
    ...
    public void addNewProductToAgreement(){
        ...
        Response response= facade.addNewProductToAgreement(id,price,catalogId,manfucator,name);
        if(response.ErrorMessage!=null){
            System.out.println((response.ErrorMessage));
        }
    ...
    public void removeProductFromSupplier(){
        ...
        else
        {
            ...
            if(response2.ErrorMessage!=null){
                System.out.println((response2.ErrorMessage));
            }
            else
...
public void printSupplier(){
    ...
    if(responseT.ErrorMessage!=null){
        System.out.println((responseT.ErrorMessage));
    }
    else{
        System.out.printf("%-30s%-30s%-30s%-30s%-30s\n","id","name","bank Account","payment method","Contacts");
        System.out.printf("%-30s%-30s%-30s%-30s\n",responseT.value.id,responseT.value.supplierName,responseT.value.bankAcount,responseT.value.paymentMethods);
        List<contactResponse> cr=responseT.value.contacts;
        System.out.printf("%-120s%-30s%-30s%-30s%-30s\n","","id","name","Email","Phone Number");
        for(int i=0;i<responseT.value.contacts.size();i++){
...
public void printAllSuppliers() {
    ...
    if(responseT.ErrorMessage!=null){
        ...
        List<SupplierResponse> lrs=responseT.value;
    ...
    public void printAgreement(){
        ...
        if(responseT.ErrorMessage!=null){
            ...
            AgreementResponse agreementResponse = responseT.value;
            ...
            List<productResponse> productResponseList =agreementResponse.products;
            System.out.printf("%-22s%-22s%-22s%-22s\n","Catalog ID","produc name","manfucator","produc price");
            for(int i=0;i<productResponseList.size();i++){
                System.out.printf("%-22d%-22s%-22s%-22s\n",productResponseList.get(i).CatalogID,productResponseList.get(i).name,productResponseList.get(i).manfucator,productResponseList.get(i).price);
            }
