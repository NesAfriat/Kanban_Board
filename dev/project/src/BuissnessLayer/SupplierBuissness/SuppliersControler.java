...
public class SuppliersControler implements ISupplierControler {
   ...
   // }
    private void AddNewAgreement(int id, DeliveryMode deliveryMode, List<Integer> daysOfDelivery, int NumOfDaysFromDelivery, Product product) {
        agreementManager.AddNewAgreement(id,deliveryMode,daysOfDelivery,NumOfDaysFromDelivery,product);
    ...
    @Override
    public void addNewSupplier(int id, String name, String bankAccount, paymentMethods paymentMethods, DeliveryMode deliveryMode, List<Integer> daysOfDelivery, int NumOfDaysFromDelivery, String contactName,String contactEmail,String phoneNumber, Product product) {
        ...
        SupplierIdCounter++;
        AddNewAgreement(id,deliveryMode, daysOfDelivery,NumOfDaysFromDelivery,product);
    }
    ...
    public void addNewContact(int SupId,String contactName,String contactEmail,String phoneNumber) {
        ...
        if (!isValidUsername(contactName)){throw new IllegalArgumentException("Illegal contact Name");}
        if(!validatePhoneNumber(phoneNumber)){
            throw new IllegalArgumentException("the phone number form is incorect");
        }
        if (!isSupplierExist(SupId)) {
