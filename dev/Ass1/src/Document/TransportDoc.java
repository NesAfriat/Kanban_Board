...
public class TransportDoc {
    ...
    public TransportDoc(int id, Date transDate, Date leftOrigin, Truck truck, Driver driver, Store origin, HashMap<Integer, Store> destinationStore, HashMap<Integer, Supplier> destinationSupplier, Area area, double truckWeightDep, List<Triple<Product, Integer, Store>> productList) {
        this.id = id;
        TransDate = transDate;
    ...
    public TransportDoc copyDeep(){
        ...
        return new TransportDoc(id,TransDate,LeftOrigin,truck,driver,origin,destinationStoreCopy,destinationSupplierCopy,area,truckWeightDep,productListCopy);
    }
