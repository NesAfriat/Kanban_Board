...
import Document.TransportDoc;
import Document.Triple;
...
public class DocCont {
    ...
    public TransportDoc getUpToDateDoc (TransportDoc td){
    ...
    public String docProdString(int doc){
        ...
        return theTransportBible.get(doc).productsString();
    }
    public String docInfo(int doc){

        return theTransportBible.get(doc).toString();
    }
    public String docDestinations(int doc){

        return theTransportBible.get(doc).destinationsString();
    }
    public void setTranportDate(int doc, Date date){
        theTransportBible.get(doc).setTransDate(date);

    }
    public void setDepartureTime(int doc, Date date){
        theTransportBible.get(doc).setLeftOrigin(date);
    }
